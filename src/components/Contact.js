    ...
    <div className="contact-content">
      ...
      <div className="contact-form">
        ...
        <div className="contact-icons">
          <div className="icon" onClick={() => window.location.href = "mailto:niggaman@gmail.com"}>
            <i className="fas fa-envelope"></i>
            <span>Email</span>
          </div>
          <div className="icon" onClick={() => window.location.href = "tel:+92929292"}>
            <i className="fas fa-phone-alt"></i>
            <span>Phone</span>
          </div>
          <div className="icon" onClick={() => window.location.href = "https://api.whatsapp.com/send?phone=+92929292"}>
